...
export class HierarchyLayoutService {
	...
	initDeps(deps: { ViewStateService: any; ConfigProviderService: any; LevelService: any; DataService: any; StandardFuncsService: any }) {
...
export const hierarchyLayoutService = new HierarchyLayoutService();
