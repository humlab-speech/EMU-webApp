export class AnagestService {
	...
	initDeps(deps: { ViewStateService: any; LevelService: any; LinkService: any; ConfigProviderService: any; SsffDataService: any; ArrayHelperService: any; ModalService: any; HistoryService: any; DataService: any }) {
...
export const anagestService = new AnagestService();
