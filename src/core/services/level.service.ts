...
export class LevelService{
	...
	private lasteditArea = null; // holding current edit area
	private lasteditAreaElem = null; // holding current edit area element

	initDeps(deps: { DataService: any; LinkService: any; ConfigProviderService: any; SoundHandlerService: any; ViewStateService: any }) {
