...
export class DrawHelperService{
	...
	private _osciPeaksInitialized = false;

	initDeps(deps: { ViewStateService: any; ConfigProviderService: any; SoundHandlerService: any; FontScaleService: any; SsffDataService: any; MathHelperService: any }) {
		Object.assign(this, deps);
		if (!this._osciPeaksInitialized) {
			this.osciPeaks = {};
			this._osciPeaksInitialized = true;
		}
	}
...
export const drawHelperService = new DrawHelperService();
