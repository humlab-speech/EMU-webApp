export class HierarchyManipulationService {
	...
	initDeps(deps: { HierarchyLayoutService: any; DataService: any; LevelService: any; ConfigProviderService: any }) {
...
export const hierarchyManipulationService = new HierarchyManipulationService();
