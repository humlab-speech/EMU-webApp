...
![icon](assets/artic-icon-roundCorners.svg)
...
Welcome to Artic! Artic is a fully fledged browser-based labeling and correction tool that offers a 
...
Artic is part of the next iteration of the EMU Speech Database Management System which aims to be as close to 
